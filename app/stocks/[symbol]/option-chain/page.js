...
import { ArrowLeft, ArrowRight, DollarSign, Activity, BarChart2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="col-span-1 lg:col-span-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed max-w-3xl">
                    Explore the latest options chain data for {stock.name} ({stock.symbol}) Stock. 
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-center">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
                                {generatedData?.options.map((row, i) => (
                    ...
                    <div className="border border-gray-200 dark:border-zinc-800 rounded-2xl p-6 flex flex-col justify-between h-full bg-white dark:bg-zinc-900/50">
                        <div>
                             ...
                             <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                                 Public shares 50% of our options order flow revenue with you on every trade, reducing your trading costs.
                             </p>
                        </div>
                ...
                <div className="mb-12">
                    <h2 className="text-2xl font-bold mb-6 anta-regular">How to buy {stock.name} stock on Logo</h2>
                    <div className="space-y-8">
                        {[
                            { title: 'Sign up for a brokerage account on Logo', desc: `It's easy to get started. You can sign up for an account directly on our website or by downloading the app.` },
                            { title: 'Add funds to your Logo account', desc: 'There are multiple ways to fund your account, from linking a bank account to making a deposit with a debit card or wire transfer.' },
                            { title: `Choose how much you'd like to invest`, desc: `Navigate to the Explore page. Then, type ${stock.symbol} into the search bar.` },
                            { title: 'Manage your investments in one place', desc: `You can find your newly purchased ${stock.symbol} stock in your portfolio.` }
                        ].map((step, i) => (
            ...
            <div className="col-span-1 lg:col-span-4 space-y-6">
                ...
                <div className="border border-gray-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                        ...
                        There are no commissions or pre-contract fees to trade options on Public.
                    </p>
                ...
                <div className="border border-gray-200 dark:border-zinc-800 rounded-xl p-6">
                    <h3 className="text-lg font-bold mb-4">Explore other options chain</h3>
                     <div className="space-y-4">
                        {stocks.filter(s => s.symbol !== stock.symbol).slice(0, 6).map((s, i) => (
                            <Link key={i} href={`/stocks/${s.symbol}/option-chain`} className="flex items-center justify-between group">
                                <div className="flex items-center gap-3">
                ...
                <div className="text-[10px] text-gray-400 leading-tight border-t border-gray-100 dark:border-zinc-800 pt-4">
                    Disclaimer: Any investment guidelines, which may be available on the Public platform, is intended to be used for informational purposes only.
                </div>
            </div>
